...
let torontoData = "https://raw.githubusercontent.com/jgoeman/Mapping_Earthquakes/main/torontoRoutes.json"
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
      ...
      onEachFeature: function(feature,layer) {
        console.log(feature)
        layer.bindPopup("<h2> Airline: "  + feature.properties.airline + "<hr></hr>" + "<h3> Destination: "+ feature.properties.dst +"</h3>" + "</h2>")
      }
  })
